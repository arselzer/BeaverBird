...
BeaverBird.canvas = function() {
  ...
  return crc32(imageData.data).toString()
}
...
// CRC32 implementation (https://github.com/otherlab/typedarray-crc32), MIT License
// Works on typed arrays.

BeaverBird.CRC_TABLE = [
...
function crc32(array, previous) {
  ...
  for (var n = 0; n < array.length; n++) {
    crc = BeaverBird.CRC_TABLE[(crc ^ array[n]) & 0xff] ^ (crc >>> 8);
  }
  return (crc ^ -1);
};
